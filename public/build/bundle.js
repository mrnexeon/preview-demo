...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/client/style.css\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_css__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _ViewerLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ViewerLoader */ \"./src/client/ViewerLoader.js\");\n/* harmony import */ var _stringParser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stringParser */ \"./src/client/stringParser.js\");\n\n\n\n\n$.getJSON('/auth', (data) => {\n    var specifiedEvent = Object(_stringParser__WEBPACK_IMPORTED_MODULE_2__[\"getSpecifiedEventId\"])();\n    var specifiedPlace = Object(_stringParser__WEBPACK_IMPORTED_MODULE_2__[\"getSpecifiedPlaceId\"])();\n    var isFullscreen = !!specifiedPlace && !!specifiedEvent;\n\n    var eventId = isFullscreen ? specifiedEvent : onMessageRecieved.eventId;\n    var placeId = isFullscreen ? specifiedPlace : onMessageRecieved.forgeId;\n\n    Object(_ViewerLoader__WEBPACK_IMPORTED_MODULE_1__[\"load\"])(data, eventId, placeId);\n})\n\nvar onMessageRecieved = (event) => {\n    onMessageRecieved.forgeId = Object(_stringParser__WEBPACK_IMPORTED_MODULE_2__[\"getSpecifiedPlaceId\"])(event.data);\n    onMessageRecieved.eventId = Object(_stringParser__WEBPACK_IMPORTED_MODULE_2__[\"getSpecifiedEventId\"])(event.data);\n    Object(_ViewerLoader__WEBPACK_IMPORTED_MODULE_1__[\"sitWhenReady\"])(onMessageRecieved.forgeId);\n}\n\nwindow.addEventListener(\"message\", onMessageRecieved, false);\n\n\n//# sourceURL=webpack:///./src/client/index.js?");

/***/ }),

/***/ "./src/client/stringParser.js":
/*!************************************!*\
  !*** ./src/client/stringParser.js ***!
  \************************************/
/*! exports provided: getSpecifiedPlaceId, getSpecifiedEventId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getSpecifiedPlaceId\", function() { return getSpecifiedPlaceId; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getSpecifiedEventId\", function() { return getSpecifiedEventId; });\nvar getSpecifiedPlaceId = (str) => {\n    var source = !!str ? str : window.location.href;\n    var match = source.match(/place=([\\d]+)/);\n    if (match === null) return NaN;\n    return parseInt(match[1]);\n}\n\nvar getSpecifiedEventId = (str) => {\n    if (!getSpecifiedEventId.cache) {\n        var source = !!str ? str : window.location.href;\n        var match = source.match(/eventId=([\\d]+)/);\n        if (match !== null) {\n            getSpecifiedEventId.cache =  parseInt(match[1]);\n        } else {\n            return NaN;\n        }\n    }\n    return getSpecifiedEventId.cache;\n}\n\n\n\n\n\n//# sourceURL=webpack:///./src/client/stringParser.js?");
